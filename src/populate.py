from src.models.user_models import User, Role, UserRoles, db
from src.models.strain_models import Strains
...
def my_function():
    with application.app_context():
        ...
        user2 = User(username='usename2', email='user2@user.com', password=generate_password_hash('password123', method='sha256'), gender="Female", age='22',)
